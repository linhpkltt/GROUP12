<%-- 
    Document   : NewHotelService
    Created on : Oct 17, 2020, 11:41:00 PM
    Author     : duchan
--%>
     ...
     <div class="col-md-8">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title " style="font-weight: bold">New HotelService</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
       <f:form action="insertHotelservice.htm" commandName="hotelserviceNew">
            <table border="1">
                <tr>
