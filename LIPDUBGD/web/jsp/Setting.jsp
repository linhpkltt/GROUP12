<%-- 
    Document   : Setting
    Created on : Oct 15, 2020, 10:24:19 PM
    Author     : duchan
--%>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <a  class="btn btn-success" href="initInsertSetting.htm"> Add Setting</a>
                            ...
                            <div class="box-body table-responsive no-padding">
                                <table class="table table-hover" boder="2">
                                    ...
                                    <tbody>
                                        <c:forEach items="${listSetting}" var="pro">
                                            <tr>
                                                <td>${pro.settingId}</td>
                                                <td>${pro.email}</td>
                                                <td>${pro.phoneNumber}</td>
                                                <td><img src="${pro.logo}"/></td>
                                                <td>${pro.value}</td>
                                                <td> 

                                                    <a class="btn btn-success" href="initUpdateSetting.htm?settingId=${pro.settingId}">Update </a>
                                                    <a class="btn btn-success" href="deleteSetting.htm?settingId=${pro.settingId}">Delete </a>
                                                </td>
