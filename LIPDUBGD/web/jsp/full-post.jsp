...
<!-- Mirrored from demo.gridgum.com/templates/Travel-agency/full-post.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Aug 2020 11:15:51 GMT -->
<head>
      ...
      <div class="col-sm-12">
        <div class="blog_content">
          ...
          <div class="post post-full">
                      ...
                      <div class="carousel main">
                        <ul>
                          <li>
                            <div class="sl1">
                              <div class="sl1_inner">
                                <img src="../images/sl01.jpg" alt="" class="img-responsive">
                              </div>
                            </div>
                          </li>
                          <li>
                            <div class="sl1">
                              <div class="sl1_inner">
                                <img src="../images/sl02.jpg" alt="" class="img-responsive">
                              </div>
                            </div>
                          </li>
                          <li>
                            <div class="sl1">
                              <div class="sl1_inner">
                                <img src="../images/sl03.jpg" alt="" class="img-responsive">
                              </div>
                            </div>
                          </li>
                        </ul>
            ...
            <c:forEach items="${listBlog}" var="pro">
            <div class="post-story">
              <h2><td>${pro.blogName}</td></h2>

              <div class="post-story-info">
                <div class="date1"><td>${pro.dateCreated}</td></div>
                <div class="by">Posted by <a href="#"><td>${pro.blogId}</td></a>   /   <a href="#">26</a> Comments</div>
              </div>

              <div class="post-story-body clearfix">
                    <td>${pro.blogContent}</td>
              </div>
          ...
          <div class="comment-block clearfix">
            ...
            <div class="caption">
              <div class="top clearfix">
                <div class="txt1">By <a href="#"><td>${listComment.commentId}</td></a></div><span>|</span>
                <div class="txt2">Date: <td>${listComment.dateCreated}</td></div><span>|</span>
                <div class="txt3"><a href="#">Reply</a></div>
              </div>
              <div class="txt">
                <td>${listComment.commentContent}</td>
              </div>
            </div>
          </div>
            </c:forEach>
