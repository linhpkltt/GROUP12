<%-- 
    Document   : Banner
    Created on : Oct 15, 2020, 9:59:29 AM
    Author     : duchan
--%>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <a  class="btn btn-success" href="initInsertBanner.htm"> Add Banner</a>
                            ...
                            <div class="box-body table-responsive no-padding">
                                <table class="table table-hover" boder="2">
                                    ...
                                    <tbody>
                                        <c:forEach items="${listBanner}" var="pro">
                                            <tr>
                                                <td>${pro.bannerId}</td>
                                                <td>${pro.bannerName}</td>
                                                <td><img src="${pro.bannerImage}"/></td>
                                                <td>${pro.title}</td>
                                                <td>${pro.bannerLink}</td>
                                                <td> 

                                                    <a class="btn btn-success" href="initUpdateBanner.htm?bannerId=${pro.bannerId}">Update </a>
                                                    <a class="btn btn-success" href="deleteBanner.htm?bannerId=${pro.bannerId}">Delete </a>
                                                </td>
