                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <a  class="btn btn-success" href="initInsertHotel.htm"> Add Hotel</a>
                                ...
                                <table class="table table-hover" boder="2">
                                    ...
                                    <tbody>
                                        <c:forEach items="${listHotel}" var="listHotel">
                                            <tr>
                                                <td>${listHotel.hotelId}</td>
                                                <td>${listHotel.hotelName}</td>
                                                <td>${listHotel.city}</td>
                                                <td>${listHotel.descriptions}</td>
                                                <td>${listHotel.price}</td>
                                                <td><img src="${listHotel.images}"/></td>
                                                <td>${listHotel.hotelStatus}</td>

                                                <td> 

                                                    <a class="btn btn-success" href="initUpdateHotel.htm?hotelId=${listHotel.hotelId}">Update </a>
                                                    <a class="btn btn-success" href="deleteHotel.htm?hotelId=${listHotel.hotelId}">Delete </a>
                                                </td>
