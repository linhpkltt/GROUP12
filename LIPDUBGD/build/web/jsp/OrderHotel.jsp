<%-- 
    Document   : OrderHotel
    Created on : Oct 18, 2020, 6:54:26 PM
    Author     : duchan
--%>

<%-- 
    Document   : quanlykhachsan
    Created on : Oct 13, 2020, 8:39:16 PM
    Author     : duchan
--%>
...
<html>
    <head>
        ...
        <title>OrderHotel Management</title>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <a  class="btn btn-success" href="initInsertOrderHotel.htm"> New OrderHotel</a>
                            ...
                            <div class="box-body table-responsive no-padding">
                                <table class="table table-hover" boder="2">
                                    ...
                                    <tbody>
                                        <c:forEach items="${listOrderhotel}" var="listOrderhotel">
                                            <tr>
                                                <td>${listOrderhotel.orderHotelId}</td>
                                                <td>${listOrderhotel.orderr.userr.userId}</td>
                                                <td>${listOrderhotel.orderr.userr.userName}</td>
                                                <td>${listOrderhotel.hotel.hotelName}</td>
                                                <td>${listOrderhotel.hotel.price}</td>
                                                <td> 

                                                    <a class="btn btn-success" href="initUpdateOrderhotel.htm?orderHotelId=${listOrderhotel.orderHotelId}">Update </a>
                                                    <a class="btn btn-success" href="deleteOrderHotel.htm?orderHotelId=${listOrderhotel.orderHotelId}">Delete </a>
                                                </td>
