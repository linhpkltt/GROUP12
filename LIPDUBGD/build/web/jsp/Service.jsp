<%-- 
    Document   : Servicee
    Created on : Oct 17, 2020, 9:02:44 PM
    Author     : duchan
--%>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <a  class="btn btn-success" href="initInsertService.htm"> Add Service</a>
                            ...
                            <div class="box-body table-responsive no-padding">
                                <table class="table table-hover" boder="2">
                                    ...
                                    <tbody>
                                        <c:forEach items="${listService}" var="pro">
                                            <tr>
                                                <td>${pro.serviceId}</td>
                                                <td>${pro.serviceName}</td>
                                                <td>${pro.price}</td>
                                                <td>${pro.descriptions}</td>
                                                <td>${pro.serviceStatus}</td>
                                                <td> 

                                                    <a class="btn btn-success" href="initUpdateService.htm?serviceId=${pro.serviceId}">Update </a>
                                                    <a class="btn btn-success" href="deleteService.htm?serviceId=${pro.serviceId}">Delete </a>
                                                </td>
