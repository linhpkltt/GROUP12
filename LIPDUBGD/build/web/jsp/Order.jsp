<%-- 
    Document   : Order
    Created on : Oct 18, 2020, 6:03:30 PM
    Author     : duchan
--%>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <a  class="btn btn-success" href="initInsertOrder.htm"> Add Order</a>
                                    ...
                                    <tbody>
                                        <c:forEach items="${listOrder}" var="listOrder">
                                            <tr>
                                                ...
                                                <td>${listOrder.userr.userName}</td>
                                                <td> 

                                                    <a class="btn btn-success" href="initUpdateOrder.htm?orderId=${listOrder.orderId}">Update </a>
                                                    <a class="btn btn-success" href="deleteOrder.htm?orderId=${listOrder.orderId}">Delete </a>
                                                </td>
