<%-- 
    Document   : Hotelservice
    Created on : Oct 17, 2020, 11:35:52 PM
    Author     : duchan
--%>
...
<html>
    <head>
        ...
        <title>HotelService Management</title>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <a  class="btn btn-success" href="initInsertHotelservice.htm"> Add HotelService</a>
                            ...
                            <div class="box-body table-responsive no-padding">
                                <table class="table table-hover" boder="2">
                                    ...
                                    <tbody>
                                        <c:forEach items="${listHotelservice}" var="listHotelservice">
                                            <tr>
                                                <td>${listHotelservice.hotelServiceId}</td>
                                                <td>${listHotelservice.hotel.hotelName}</td>                                           
                                                <td>${listHotelservice.servicee.serviceName}</td>
                                                <td>${listHotelservice.price}</td>
                                                <td> 

                                                    <a class="btn btn-success" href="initUpdateHotelservice.htm?hotelServiceId=${listHotelservice.hotelServiceId}">Update </a>
                                                    <a class="btn btn-success" href="deleteHotelservice.htm?hotelServiceId=${listHotelservice.hotelServiceId}">Delete </a>
                                                </td>
