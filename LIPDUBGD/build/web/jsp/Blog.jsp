 <%-- 
    Document   : Blog
    Created on : Oct 15, 2020, 11:13:49 AM
    Author     : duchan
--%>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <a  class="btn btn-success" href="initInsertBlog.htm"> Add Blog</a>
                                    ...
                                    <tbody>
                                        <c:forEach items="${listBlog}" var="pro">
                                            <tr>
                                                ...
                                                <td>${pro.blogStatus}</td>
                                                <td> 

                                                    <a class="btn btn-success" href="initUpdateBlog.htm?blogId=${pro.blogId}">Update </a>
                                                    <a class="btn btn-success" href="deleteBlog.htm?blogId=${pro.blogId}">Delete </a>
                                                </td>
