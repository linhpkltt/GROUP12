<%-- 
    Document   : Comment
    Created on : Oct 16, 2020, 4:32:16 PM
    Author     : duchan
--%>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <a  class="btn btn-success" href="initInsertComment.htm"> Add Comment</a>
                                ...
                                <table class="table table-hover" boder="2">
                                    ...
                                    <tbody>
                                        <c:forEach items="${listComment}" var="listComment">
                                            <tr>
                                                <td>${listComment.commentId}</td>
                                                <td>${listComment.blog.blogName}</td>
                                                <td>${listComment.userr.userName}</td>
                                                <td>${listComment.commentContent}</td>
                                                <td>${listComment.dateCreated}</td>
                                                <td>${listComment.parentId}</td>
                                                <td> 

                                                    <a class="btn btn-success" href="initUpdateComment.htm?commentId=${listComment.commentId}">Update </a>
                                                    <a class="btn btn-success" href="deleteComment.htm?commentId=${listComment.commentId}">Delete </a>
                                                </td>
